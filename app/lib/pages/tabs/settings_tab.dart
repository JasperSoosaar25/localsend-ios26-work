  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        ...
        final nativeIOS = supportsNativeIOS26Controls;
        return ResponsiveListView(
          ...
          children: [
            if (nativeIOS) ...[
              IOS26LargeTitle(title: t.settingsTab.title),
                ...
                if (!nativeIOS)
                  _SettingsEntry(
                    ...
                    child: CustomDropdownButton<ColorMode>(
                      ...
                      onChanged: (colorMode) =>
                          vm.onChangeColorMode(context, colorMode),
                    ),
                  ),
                _ButtonEntry(
                  label: t.settingsTab.general.language,
                  buttonLabel:
                      vm.settings.locale?.getLocaleName() ??
                ...
                _BooleanEntry(
                  ...
                  onChanged: (b) async {
                    ...
                    if (b) {
                      await ref
                          .notifier(settingsProvider)
                          .setQuickSaveFromFavorites(false);
                    }
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      IOS26NativeSwitch(
                        value: vm.advanced,
                        accessibilityLabel: t.settingsTab.advancedSettings,
                        onChanged: (value) async {
                          vm.onTapAdvanced(value);
                          await ref
                              .notifier(settingsProvider)
    ...
    if (supportsNativeIOS26Controls) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsetsDirectional.only(start: 16, bottom: 7),
              child: Text(
                title,
                style: TextStyle(
                  fontSize: 13,
