  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        ...
        final nativeIOS =
            supportsNativeIOS26Controls && sizingInformation.isMobile;
        return ResponsiveListView(
          padding: EdgeInsets.zero,
          children: [
            if (nativeIOS)
              IOS26LargeTitle(title: t.sendTab.title)
            else
            ...
            SizedBox(height: nativeIOS ? 110 : 50),
          ],
        );
      },
    );
...
extension on FilePickerOption {
  String get iosSymbol {
    return switch (this) {
      FilePickerOption.file => 'doc',
      FilePickerOption.folder => 'folder',
      FilePickerOption.media => 'photo.on.rectangle.angled',
      FilePickerOption.text => 'text.quote',
      FilePickerOption.app => 'app',
      FilePickerOption.clipboard => 'doc.on.clipboard',
    };
  }
}
...
class _MultiSendDeviceListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DeviceListTile(
      ...
      onDetailsTap: () async =>
          await context.push(() => DeviceDetailsPage(device: device)),
